...
(this, function() {
	...
	var g = function(t) {
		...
		initMacy = function(t) {
			initContainer(t), initTaskQueue(t), L(t)
		},
		isArray = function(t) {
			return t === Object(t) && "[object Array]" !== Object.prototype.toString.call(t)
		},
		O = function(t, n) {
			isArray(t) || (n.columns = t), isArray(t) && t.columns && (n.columns = t.columns), isArray(t) && t.margin && !isArray(t.margin) && (n.margin = {
				x: t.margin,
				y: t.margin
			}), isArray(t) && t.margin && isArray(t.margin) && t.margin.x && (n.margin.x = t.margin.x), isArray(t) && t.margin && isArray(t.margin) && t.margin.y && (n.margin.y = t.margin.y)
		},
		C = function(t, n) {
		...
		legacyImageLoadingCanceled = function() {
	...
	var q = function t() {
		...
		this.options = {}, x(this.options, k, n), this.options.cancelLegacy && !legacyImageLoadingCanceled() || initMacy(this)
	};
